...
//
// El vocabulario de sólidos orales (tamiz, malla, dureza, friabilidad...) no
// sirve para un inyectable estéril: ahí lo que se juega el lote es la
// esterilidad, la integridad del filtro, la biocarga y las partículas. Cada
// familia de producto que se suma trae las suyas —esto crece con cada
// documento nuevo, no se adivina de una sola vez—.
const PROCESS_KEYWORDS =
  /(TEMPERATURA|HUMEDAD|VELOCIDAD|PRESION|PRESIÓN|AMPERAJE|AMPERIO|CAUDAL|FLUJO|PESO|TIEMPO|NIVEL|ALTURA|DOSIFICACION|DOSIFICACIÓN|RENDIMIENTO|MERMA|CANTIDAD|MUESTRA|CONTRAMUESTRA|pH|VOLUMEN|DENSIDAD|DUREZA|FRIABILIDAD|DESINTEGRACION|ESPESOR|DIAMETRO|DIÁMETRO|LONGITUD|TORQUE|VACIO|VACÍO|SELLADO|HERMETICIDAD|CONCENTRACION|CONCENTRACIÓN|TAMIZ|MALLA|REVOLUCION|RPM|SALA|LINEA|LÍNEA|SECCION|SECCIÓN|POSICION|POSICIÓN|CODIGO|LECTURA|CONTROL|GRADO|VISCOSIDAD|CONDUCTIVIDAD|TURBIDEZ|ASPECTO|DESCRIPCION|DESCRIPCIÓN|FRACCION|FRACCIÓN|LUZ|AJUSTE|MORDAZA|ENVASADORA|TOLVA|DISCO|SOBRE|CAJA|APILAMIENTO|EMBALAJE|ESTERIL|ESTÉRIL|ESTERILIZACION|ESTERILIZACIÓN|ESTERILIDAD|PARTICULA|PARTÍCULA|BIOCARGA|MEMBRANA|INTEGRIDAD|AUTOCLAVE|LETALIDAD|DESPIROGENADO|APIROGENICIDAD|ENDOTOXINA|AMPOLLA|VIAL)/i;
